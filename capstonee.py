...
Original file is located at
    https://colab.research.google.com/drive/1EEn0HZwnsX9MB80zjphLPXHfvlwM1Nbr
"""
...
class preprocess:
    ...
    def __init__(
        ...
        # 기존 코드 그대로 사용
        folders = [x for x in os.listdir("/content/drive/MyDrive/Colab Notebooks/4-1/Capstone/147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/") if os."/content/drive/MyDrive/Colab Notebooks/4-1/Capstone/147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/".isdir(os."/content/drive/MyDrive/Colab Notebooks/4-1/Capstone/147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/".join("/content/drive/MyDrive/Colab Notebooks/4-1/Capstone/147.속성기반 감정분석 데이터/01-1.정식개방데이터/Training/",x))]
